...
│  │   • 新系统上线 → 新增应用系统台账                              │
│  │   • 新功能上线 → 查询+编辑应用系统台账（功能模块）                  │
│  │   • 功能变更   → 查询+勾选应用系统台账                          │
│  │   • 架构变更   → 查询+勾选应用系统台账（可能涉及云资源/数据库变更）    │
│  │   • 安全检查   → 不关联台账（全系统/指定范围安全扫描）               │
...
| 计划类型  | 台账操作方式           | 关联台账类型      | 特殊说明          |
| ----- | ---------------- | ----------- | ------------- |
| 新系统上线 | **新增**应用系统台账记录   | 应用系统、云服务、账号 | 创建全新的台账条目     |
| 新功能上线 | **编辑**已有台账（功能模块） | 应用系统台账      | 修改功能模块字段      |
| 功能变更  | **查询+勾选**已有台账    | 应用系统台账      | 标记受影响的系统      |
| 架构变更  | **查询+勾选**已有台账    | 应用系统、云服务    | 可能涉及云资源/数据库变更 |
| 安全检查  | **不关联台账**        | 无或可选范围      | 全系统扫描或指定范围检查  |
